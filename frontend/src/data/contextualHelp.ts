...
export const contextualHelpData: Record<string, FieldHelp> = {
  ...
  '8': {
    ...
    description: 'Xác định rõ cách thức AI xử lý văn bản chỉ đạo đầu vào để làm căn cứ pháp lý cho văn bản mới.',
    examples: ['Bám sát', 'Tổng hợp', 'Tham khảo', 'Trích yếu văn bản làm căn cứ', 'Đối chiếu', 'Trích ý', 'theo yêu cầu chỉ đạo'],
  },
  '9': {
    id: '9',
    title: 'Sử dụng văn bản này để làm gì?',
    description: 'Các văn bản quy phạm pháp luật, điều lệ, quy định, hướng dẫn của Đảng có liên quan trực tiếp đến nội dung.',
  ...
  '10': {
    id: '10',
    title: 'Định hướng mục đích sử dụng văn bản pháp lý',
    description: 'Xác định cách thức AI khai thác tệp văn bản pháp lý làm luận cứ vững chắc, bám sát luật hiện hành.',
  ...
  '12': {
    id: '12',
    title: 'Tài liệu đính kèm & Phụ lục',
    description: 'Nội dung hoặc các tệp tin phụ lục, bảng biểu số liệu, ảnh minh họa, biên bản cuộc họp hoặc báo cáo con bổ trợ dữ liệu.',
  ...
  '14': {
    id: '14',
    title: 'Đề cương chi tiết thiết lập sẵn',
    description: 'Nhập hoặc tải lên đề cương có sẵn để ép AI bắt buộc sử dụng khung đề cương đó làm cấu trúc nội dung chính cho văn bản.',
  },
  '15': {
    id: '15',
